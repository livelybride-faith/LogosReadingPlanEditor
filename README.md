...
I created this tool using GeminiAI for convenience that can update pages when the day is out of sync as some pages of the resources contains more than 1 page. So just sharing this out to anyone that needs it. 
